    ...
    <div>
     ...
     <Formik
       ...
       validate={values => {
         ...
         if (!values['Middle Name'].lenghth<2 || !values['Middle Name'].length>30) {
           errors['Middle Name'] = 'Middle Name must be between 2 and 30 characters';
         return errors;}

         if (!values['Last Name'].lenghth<2 || !values['Last Name'].length>50) {
           errors['Last Name'] = 'Last Name must be between 2 and 50 characters';
         return errors;}
     ...
     >
       {({ isSubmitting }) => (
         ...
         <Form>
           ...
           <Field type="address line 1" name="address line 1" placeholder="adress line 1"alignItem="center" />
           <ErrorMessage name="address line 1" component="div" />

           <Field type="address line 2" name="address line 2" placeholder="adress line 2"alignItem="center" />
           <ErrorMessage name="address line 1" component="div" />
